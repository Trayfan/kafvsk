...
class Test_sub(MainTest):
    def __init__(self, cl):
        self.logger = cl
        self.test_name = r"REG-783 Проверить заполнение ответа при успешном вызове запроса на изменение статуса доп соглашения ОСАГО и еОСАГО (Type = Addendum) (Errors.Code=0)"
