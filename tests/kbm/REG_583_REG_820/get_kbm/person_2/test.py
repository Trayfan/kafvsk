...
class Test_sub(MainTest):
    def __init__(self, cl):
        self.logger = cl
        self.test_name = r"REG-583, REG-820 КБМ Проверить заполнение ответа при успешном выполнении запроса КБМ по 2 ФЛ (Errors.Code=0)"
        self.logger.info(f"# Start test {self.test_name}")

        self.PATH = r".\tests\kbm\REG_583_REG_820\get_kbm\person_2"
